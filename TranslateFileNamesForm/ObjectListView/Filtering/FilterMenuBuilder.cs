...
namespace BrightIdeasSoftware
{
    ...
    public class FilterMenuBuilder
    {
        ...
        /// </summary>
        static public Bitmap ClearFilteringImage = TranslateFileNamesForm.Resources.Resource1.ClearFiltering;

        /// <summary>
        /// Gets or sets the image that will be placed next to all "Apply" menu items on the filtering menu
        /// </summary>
        static public Bitmap FilteringImage = TranslateFileNamesForm.Resources.Resource1.Filtering;
